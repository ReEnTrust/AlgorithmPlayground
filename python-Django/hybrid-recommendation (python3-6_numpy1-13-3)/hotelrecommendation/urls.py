...
urlpatterns = [
    ...
    path('<str:firstname>/<str:lastname>/<int:age>/<int:target_price>/<str:physically_disabled>/<str:is_married>/<str:have_kids>/<str:gender>/<int:id_user>',views.ResultRatingUser.as_view(), name='result_user_rating'),
]
